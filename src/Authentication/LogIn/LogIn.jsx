...
<button onClick={()=>handleSocialLogin()} aria-label="Log in with Google" className="px-3 py-1 bg-emerald-600  rounded-lg border flex gap-3 items-center hover:bg-emerald-800">
