   ...
   <div className="p-20 ">
    ...
    <div className="flex items-center gap-2 mb-4 text-xl">
      ...
      <p>{OwnnerName}</p>
		...
		<Link to={`/allblogs/${_id}`}>	<button className="px-2 py-2 text-2xl font-bold w-1/2 bg-emerald-700 text-white rounded-lg hover:bg-emerald-800">Read More</button></Link>
